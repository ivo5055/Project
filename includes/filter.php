...
<form id="filterForm" method="GET" action="">
    ...
    <div>
        ...
        <input type="text" name="max_capacity" id="max_capacity" value="<?php echo isset($_GET['max_capacity']) ? $_GET['max_capacity'] : ''; ?>">
    </div>
    <div>
        <label for="min_rating">Min Rating:</label>
        <input type="text" name="min_rating" id="min_rating" value="<?php echo isset($_GET['min_rating']) ? $_GET['min_rating'] : ''; ?>">
    </div>
    <div>
        <label for="max_rating">Max Rating:</label>
        <input type="text" name="max_rating" id="max_rating" value="<?php echo isset($_GET['max_rating']) ? $_GET['max_rating'] : ''; ?>">
    </div>
    <div>
        <label for="min_price">Min Price:</label>
        <input type="text" name="min_price" id="min_price" value="<?php echo isset($_GET['min_price']) ? $_GET['min_price'] : ''; ?>">
    </div>
    <div>
        <label for="max_price">Max Price:</label>
        <input type="text" name="max_price" id="max_price" value="<?php echo isset($_GET['max_price']) ? $_GET['max_price'] : ''; ?>">
    </div>
    <div>
