...
<div class="register-container">
    ...
    <div class="register-form">
        <form id="register-form" action="includes/register.php" method="post" onsubmit="return validateForm()">
            ...
            <label for="agreement" data-translate="true">Съгласен съм с <a href="PRAVILNIK_NAST_final_2022.pdf" target="_blank" data-translate="true">условията и правилата</a></label>
            <span id="agreement-error" style="color: red;"></span><br><br>
